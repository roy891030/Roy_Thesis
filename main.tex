...
% 論文名稱
\newcommand{\chineseTitle}{基於圖神經網絡的股票收益預測與選股策略 — 融合市場結構的多因子模型}
\newcommand{\englishTitle}{Stock Return Prediction and Selection via 
        Graph Neural Networks: Integrating Market Structure into a Multi-Factor Model}
