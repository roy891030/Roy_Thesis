...
% 論文名稱
\newcommand{\chineseTitle}{圖神經網絡在股票投資組合優化中的應用：以產業關係與市場互動為基礎}
\newcommand{\englishTitle}{Application of Graph Neural Networks in Stock Portfolio Optimization: Incorporating Industry Relations and Market Interactions}
...
\newcommand{\NameofDepartmentInstituteEN}{Graduate Program of Finance, Department of Information Management and Finance}
\newcommand{\NameofDegree}{Master of Science} % 學位名稱, 常見的是Master of Science, 不同系所採用不同寫法, 記得查學校的資料.
\newcommand{\ResearchTopic}{Quantitative Finance} % 研究領域, 請看下方[說明2]
