...
\subsection{預測品質指標}
\textbf{IC / Daily IC / ICIR：}IC 為整體樣本之 Pearson correlation；Daily IC 為逐交易日 IC 之平均；ICIR（Information Coefficient Information Ratio, ICIR）定義為 Daily IC 平均除以其標準差，用以衡量穩健性。為避免與文獻常見之 rank IC 口徑混淆，本文主文結果均以 Pearson IC 為準。
