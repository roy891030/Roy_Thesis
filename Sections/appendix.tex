...
圖 \ref{fig:appendix_static_gpu_key_metrics_by_window} 將表 \ref{tab:appendix_unified_key_metrics} 的數據依 Short、Medium 與 Long 三個訓練視窗分面呈現，並標示資料期間、訓練日數、測試日數與測試期間。

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{img/appendix_static_gpu_key_metrics_by_window.png}
  \caption{全模型關鍵指標之分視窗視覺化}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \par\vspace{0.4em}
  \caption{Short window 各模型Daily IC。}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \par\vspace{0.4em}
  \caption{Medium window 各模型Daily IC。}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \par\vspace{0.4em}
  \caption{Long window 各模型Daily IC。}
...
\begin{figure}[H]
  ...
  \end{subfigure}
  \par\vspace{0.4em}
  \caption{Medium window 各模型IC 分佈。}
